...
In terms of improvements or declines in medal counts, we define \textit{"improvement"} and \textit{"decline"} as follows (in order to separate them from normal fluctuations):
